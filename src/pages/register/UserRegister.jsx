      ...
      <div className="w-full">
        <div className="w-1/2 mx-auto my-10 py-10 px-5 bg-white border-[#D9D9D9] border-2 shadow-xl flex flex-col items-center rounded-xl drop-shadow-lg">
          ...
          <div className="-mx-3 flex flex-wrap w-full">
            <div className="w-1/2 px-3 sm:w-1/2"></div>
            <div className="w-1/2 px-3 sm:w-1/2">
              ...
              <label for="Confirm-Password" className="mb-3 block text-base font-medium">Confirm-Password</label>
                <input
                  ...
                  className="w-64 h-10 rounded-md border border-[#D9D9D9] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                />
              </div>
            </div>
          </div>
